...
#define LOG(a) (__lg(a))
#define gc() (pt1==pt2&&(pt2=(pt1=buf)+fread(buf,1,1<<15,stdin),pt1==pt2)?EOF:*pt1++)
char buf[1<<15],*pt1,*pt2;
...
const int M = 2 * N;
const int MOD = 1e9 + 7;
const int X1 = 1 << 17;// 1e5;
const int X2 = 1 << 17;//1e5;
...
inline int p2(ll b) {
    b %= (MOD - 1);
    return 1ll * hwt[b >> 17] * pw2[b & (X1 - 1)] % MOD;
}
